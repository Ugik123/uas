...
public class transaksi_makanan extends javax.swing.JFrame {
    ...
    //deklarasi variabel
    String kode_transaksi, kode_makanan, nama_makanan, xtotal;
    ...
    public void dataProduk(){   
        try{
            ...
            String sql = "SELECT * FROM tabel_makanan WHERE kode_makanan = '"+ txtkode_makanan.getText() +"'";
            ResultSet res = stat.executeQuery(sql);
                        
            //baca data dan tampilkan pada text produk dan harga
            while(res.next()){
                //membuat obyek berjenis array
               txtnm_makanan.setText(res.getString("nama_makanan"));
               txtharga.setText(res.getString("harga_makanan"));
            }
    ...
    public void masukTabel(){
        try{
            ...
            String kode_makanan=txtkode_makanan.getText();
            String nama_makanan=txtnm_makanan.getText();
            double harga_makanan=Double.parseDouble(txtharga.getText());
            int total_beli=Integer.parseInt(txt_totalbel.getText());
            sTotal = harga_makanan*total_beli;
            total = total + sTotal;
            xtotal=Double.toString(total);
            lbl_totbay.setText(xtotal);
            model.addRow(new Object[]{kode_transaksi, kode_makanan, harga_makanan,harga_makanan,total_beli,sTotal});
    ...
    public void simpanDataTransaksi(){ 
        ...
        try{
            ...
            String  sql =   "INSERT INTO transaksi_makanan (kode_transaksi, kode_makanan, nama_makanan, harga_makanan, total_beli, total_bayar, kembali)"
    ...
    private void initComponents() {
        ...
        jLabel1.setText("TRANSAKSI MAKANAN");

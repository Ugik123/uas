 ...
 * @author asus
 */
public class transaksi_tambahan extends javax.swing.JFrame {

     //membuat objek    
    private DefaultTableModel model;
    
    //deklarasi variabel
    String kode_transaksi, kode_tambahan, nama_tambahan, xtotal;
    int harga_makanan, total_beli;
    double total, bayar, kembali, sTotal;
    /**
     * Creates new form transaksi_tambahan
     */
    public transaksi_tambahan() {
        initComponents();
        
        model = new DefaultTableModel();
         //memberi nama header pada tabel
        tbl_transaksi_tambahan.setModel(model);
    ...
    public void dataProduk(){   
        try{
            ...
            String sql = "SELECT * FROM tabel_tambahan WHERE kode_tambahan = '"+ txtkode_makanan.getText() +"'";
            ResultSet res = stat.executeQuery(sql);
                        
            //baca data dan tampilkan pada text produk dan harga
            while(res.next()){
                //membuat obyek berjenis array
               txtnm_makanan.setText(res.getString("nama_tambahan"));
               txtharga.setText(res.getString("harga_tambahan"));
            }
    ...
    public void masukTabel(){
        try{
            ...
            String kode_tambahan=txtkode_makanan.getText();
            String nama_tambahan=txtnm_makanan.getText();
            double harga_tambahan=Double.parseDouble(txtharga.getText());
            int total_beli=Integer.parseInt(txt_totalbel.getText());
            sTotal = harga_tambahan*total_beli;
            total = total + sTotal;
            xtotal=Double.toString(total);
            lbl_totbay.setText(xtotal);
            model.addRow(new Object[]{kode_transaksi, kode_tambahan, nama_tambahan,harga_tambahan,total_beli,sTotal});
    ...
    public void simpanDataTransaksi(){ 
        ...
        try{
            ...
            String  sql =   "INSERT INTO transaksi_tambahan (kode_transaksi, kode_tambahan, nama_tambahan, harga_tambahan, total_beli, total_bayar, kembali)"
    ...
    private void initComponents() {
        ...
        tbl_transaksi_tambahan = new javax.swing.JTable();
        ...
        jLabel1.setText("TRANSAKSI MAKANAN TAMBAHAN");

        jLabel2.setText("KODE TRANSAKSI");

        jLabel3.setText("KODE TAMBAHAN");

        jLabel4.setText("NAMA TAMBAHAN");
        ...
        tbl_transaksi_tambahan.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        jScrollPane1.setViewportView(tbl_transaksi_tambahan);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(transaksi_tambahan.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JTable tbl_transaksi_tambahan;
